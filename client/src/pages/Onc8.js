...
function Onc8(props) {
  return (
    ...
    <div className="main-app">
      ...
      <Answer text="소니 F65 시네알타 4K로 열정으로 찍는다." value="E" />
      <Answer text="주섬주섬 휴대폰을 꺼내 대충 찍는다" value="A" />
      <Answer text="삼각대를 세우고 찍게 한 후 구경한다." value="A" />
      <Answer text="일단 햄버거부터 먹자고 말한다" value="B" />
    </div>
  );
}
