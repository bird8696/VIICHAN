...
function Onc3(props) {
  ...
  return (
    ...
    <div className="main-app">
      ...
      <Answer text="동생이 언니에게 장난도 칠 수 있지" value="A" nextPage={4} />
      <Answer text="어쩌라구 그러게 동생 관리좀 하지 그랬어" value="B" nextPage={4} />
      <Answer text="둘다 보기 좋아보여" value="D" nextPage={4} />
      <Answer text="(아이네님을 끌어안으면서)내가 지켜줄게" value="C" nextPage={4} />
    </div>
  );
}
